...
<div class="help index large-9 medium-8 columns content">
    <h3><?= __('View Employer Help') ?></h3>
    <p>This page shows a detailed view of any emloyer profile. Name, address, phone, and website are listed, as well as any jobs that the employer has listed currently.</p>
</div>
