...
class DevelopersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'IX_developers_user_id' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'UQ_developers_user_id' => ['type' => 'unique', 'columns' => ['user_id'], 'length' => []],
            'FK_developer_user_id' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
